-- Migration: Add plan_expires_at to get_all_users_for_admin RPC
-- This allows admin to see plan expiry dates in User Management
...
-- Add comment
COMMENT ON FUNCTION get_all_users_for_admin IS 'Returns all users in the platform for admin view including plan expiry date';
