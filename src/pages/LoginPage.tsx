...
export function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center h-[calc(100vh-80px)] bg-muted/40">
      <div className="w-full max-w-sm mx-auto p-8 bg-brand-white border-4 border-brand-black shadow-hard">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-display font-bold text-brand-black">Admin Access</h1>
          <p className="font-mono text-muted-foreground">Enter credentials to manage WarungOS.</p>
        </div>
