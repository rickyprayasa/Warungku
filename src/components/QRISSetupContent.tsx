    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white border-2 border-brand-black p-4 space-y-4 h-fit">
                ...
                <div className="bg-white border-2 border-brand-black p-4 space-y-4 h-fit">
                    ...
                    <div className="bg-blue-50 border-2 border-blue-200 p-4">
                        ...
                        <p className="font-mono text-xs text-blue-700 leading-relaxed">
                            Anda cukup mengupload <strong>QRIS Static</strong> dari bank/e-wallet. Sistem Warungku akan <strong>otomatis mengubahnya menjadi QRIS Dinamis</strong> saat pelanggan checkout, sehingga nominal pembayaran langsung muncul.
                        </p>
                    </div>
                                        ...
                                        <>
                                            ...
                                            {qrisInfo && (
                                                <div className="font-mono text-xs text-green-700 mt-1 space-y-0.5">
                                                    ...
                                                    <p>Tipe: {qrisInfo.pointOfInitiation === 'static' ? 'Static (Otomatis jadi Dynamic saat checkout)' : 'Dynamic'}</p>
                                                </div>
                                            )}
                                        </>
                                    ) : (
