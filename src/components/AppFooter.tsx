import { ExternalLink, Youtube, Instagram, Share2, Download, Facebook, Twitter, Share } from 'lucide-react';
            ...
            <div className="space-y-3">
              ...
              <Dialog>
                <DialogTrigger asChild>
                  <button className="flex items-center justify-center md:justify-start gap-2 font-mono text-sm text-gray-300 hover:text-brand-orange transition-colors group w-full md:w-auto">
